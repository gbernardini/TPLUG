...
namespace PresentacionUI
{
    public partial class GestionarMascotas : Form
    {
        ...
        {
            Dictionary<string, int> ListaDatos = new Dictionary<string, int>();

            foreach (PaseadorBE Paseador in Paseadores) {
                ListaDatos.Add(Paseador.Nombre, Paseador.CantMaxMascotas);
            }
            ...
            Title Titulo = new Title("Cantidad de Mascotas por paseador");
            ...
            Series serie = new Series("Mascotas");
